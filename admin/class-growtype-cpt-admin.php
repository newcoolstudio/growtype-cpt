...
class Growtype_Cpt_Admin
{
    ...
    {
        wp_enqueue_style($this->growtype_cpt, plugin_dir_url(__FILE__) . 'css/growtype-cpt-admin.css', array (), $this->version, 'all');
    }
    ...
    {
        wp_enqueue_script($this->growtype_cpt, plugin_dir_url(__FILE__) . 'js/growtype-cpt-admin.js', array ('jquery'), $this->version, false);
    }
